...
goog.exportSymbol('proto.BulkFields', null, global);
 ...
 * @constructor
 */
proto.BulkFields = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.BulkFields, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.BulkFields.displayName = 'proto.BulkFields';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.BulkFields.prototype.toObject = function(opt_includeInstance) {
  return proto.BulkFields.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.BulkFields} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BulkFields.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.BulkFields}
 */
proto.BulkFields.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.BulkFields;
  return proto.BulkFields.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.BulkFields} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.BulkFields}
 */
proto.BulkFields.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.BulkFields.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BulkFields.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.BulkFields} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BulkFields.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
